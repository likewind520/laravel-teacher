                    ...
                    <div class="card-body">
                        ...
                        <!--/row-->
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="name" value="{{$category['name']}}" placeholder="请输入栏目名称"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select name="pid" class="form-control custom-select"
                                            data-placeholder="Choose a Category"
                                            tabindex="1">
                                        <option value="0">顶级栏目</option>
                                        @foreach($categories as $v)
                                            <option @if( $v['id'] ==$category['pid'] ) selected @endif value="{{$v['id']}}">{{$v['_name']}}</option>
                                        @endforeach
                                    </select>
