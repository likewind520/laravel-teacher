                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" placeholder="请输入商品名称" name="title" value="{{old('title')}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label text-right col-md-3">商品价格</label>
                                <div class="col-md-9">
                                    <input type="number" placeholder="请输入商品价格" name="price" value="{{old ('price')}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
    ...
    <script>
        layui.use(['upload', 'layedit'], function () {
            ...
            upload.render({
                ...
                , acceptMime:{!! hd_config('upload.upload_accept_mime') !!}                                   //'image/jpg|image/png'
                , size:{!! hd_config('upload.upload_size') !!} //最大允许上传的文件大小，单位 KB。不支持ie8/9
                , exts:{!! hd_config('upload.upload_type') !!}                                     //'jpg|png'
            ...
            upload.render({
                ...
                , size: 20000000 //最大允许上传的文件大小，单位 KB。不支持ie8/9
                , exts: 'jpg|png'
                // ,before: function(obj){
                //     //预读本地文件示例，不支持ie8
