    ...
    <script>
        layui.use(['upload', 'layedit'], function () {
            ...
            upload.render({
                ...
                , acceptMime:"{{hd_config ('upload.upload_accept_mime','image/jpg, image/png,image/jpeg')}}"                                  //'image/jpg|image/png'
                , size:"{{hd_config ('upload.upload_size',20000000)}}" //最大允许上传的文件大小，单位 KB。不支持ie8/9
                , exts:"{{hd_config ('upload.upload_type','jpg|png|gif|bmp|jpeg')}}"                                    //'jpg|png'
