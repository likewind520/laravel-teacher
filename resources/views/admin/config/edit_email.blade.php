                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="APP_NAME" placeholder=""
                                           value="{{$config['data']['APP_NAME']}}" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="APP_URL" placeholder=""
                                           value="{{$config['data']['APP_URL']}}" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="MAIL_PORT" placeholder=""
                                           value="{{$config['data']['MAIL_PORT']??'25'}}" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="MAIL_USERNAME" placeholder=""
                                           value="{{$config['data']['MAIL_USERNAME']??''}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="password" name="MAIL_PASSWORD" placeholder=""
                                           value="{{$config['data']['MAIL_PASSWORD']??''}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="MAIL_ENCRYPTION" placeholder=""
                                           value="{{$config['data']['MAIL_ENCRYPTION']??'tls'}}" class="form-control">
