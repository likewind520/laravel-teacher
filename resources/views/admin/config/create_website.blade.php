                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="site_name" placeholder="请输入网站名称"
                                           value="{{$config['data']['site_name']}}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="site_icp" value="{{$config['data']['site_icp']}}"
                                           placeholder="请输入 icp 备案信息" class="form-control">
                                </div>
                            </div>
                            <hr>
    ...
    <script>
        layui.use(['upload', 'layedit'], function () {
            ...
            upload.render({
                ...
                , acceptMime: "{{hd_config ('upload.upload_accept_mime','image/jpg, image/png,image/jpeg')}}"//打开浏览只能看到设置的格式
                , size:"{{hd_config ('upload.upload_size',20000000)}}" //最大允许上传的文件大小，单位 KB。不支持ie8/9
                , exts: "{{hd_config ('upload.upload_type','jpg|png|gif|bmp|jpeg')}}" //上传的允许类型
