            ...
            <div class="orderright">
                <div class="orderlist">
                    ...
                    <div style="padding: 30px">
                        <form method="post" class="layui-form" action="{{route('home.address.update',$address)}}">
                            @csrf @method('PUT')
                            <div class="layui-form-item">
                                <label class="layui-form-label">收货人姓名</label>
                                <div class="layui-input-block">
                                    <input type="text" name="name"  placeholder="请输入用户昵称" value="{{$address['name']}}" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item" id="distpicker">
                                <label class="layui-form-label">选择地址</label>
                                <div class="layui-input-inline">
                                    <select name="province" value="" lay-filter="a" id="a"></select>
                                </div>
                                <div class="layui-input-inline">
                                    <select name="city" value="" lay-filter="b" id="b"></select>
                                </div>
                                <div class="layui-input-inline">
                                    <select name="district" value="" lay-filter="c" id="c"></select>
                                </div>
                            </div>
                            <div class="layui-form-item layui-form-text">
                                <label class="layui-form-label">详细地址</label>
                                <div class="layui-input-block">
<!--                                   --><?php //dump($address->all())  ?>
                                    <textarea placeholder="" name="detail" value="" class="layui-textarea"></textarea>
                                </div>
                            </div>
                            <div class="layui-form-item">
